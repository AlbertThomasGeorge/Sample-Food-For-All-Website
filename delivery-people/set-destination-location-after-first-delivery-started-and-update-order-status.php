<?php
    ...
    if(mysqli_num_rows($result1) == 1){
        $sql2 = "UPDATE location_tracker SET latitude_of_destination = {$latitude_to_deliver}, longitude_of_destination = {$longitude_to_deliver} WHERE delivery_person_id = {$delivery_person_id}";
