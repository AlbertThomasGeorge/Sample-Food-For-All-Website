<?php
    ...
    $delivery_person_name = mysqli_real_escape_string($conn, $_SESSION['delivery_person_name']);
    $sql1 = "SELECT * FROM  delivery_people WHERE delivery_person_name = '{$delivery_person_name}'";
    $result1 = mysqli_query($conn, $sql1);
    if($result1){
        $row1 = mysqli_fetch_assoc($result1);
        $deliverypersonid = $row1['delivery_person_id'];
        $person_id = $row1['delivery_person_id'].'D';
    }
